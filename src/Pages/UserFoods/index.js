...
const UserFoods = () => {
  ...
  const [newFoodBestSeller, setNewFoodBestSeller] = useState(null);
  ...
  const handleFoodBestSeller = (e) => {
    setNewFoodBestSeller(e.target.value);
  };
  ...
  const addFood = () => {
    ...
    axios
      .post(`foods`, {
        ...
        author: setId(localStorage.getItem("id")),
        rating: 4,
        steps: newFoodSteps,
        bestseller: newFoodBestSeller,
        success: true,
        deleted: null,
        loading: false,
      })
            ...
            <Modal show={showNew} onHide={handleClose}>
              ...
              <Modal.Body>
                <Form>
                  ...
                  <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>True ymu False</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="орцын нэр"
                      onChange={(e) => {
                        handleFoodBestSeller(e);
                      }}
                    />
                    <Form.Text className="text-muted"></Form.Text>
                  </Form.Group>
